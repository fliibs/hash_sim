...
def check_config(args):
    mask_0, mask_1, mask_2, sel_bit0, sel_bit1, mask_sel0, mask_sel1 = args
...
if __name__ == '__main__':
    ...
    #=====================================================
    task_args = [
        (m0, m1, m2, b0, b1, ms0, ms1)
        for m0 in range(8)
        for m1 in range(8)
        for m2 in range(8)
        for b0 in range(20,29)
        for b1 in range(20,30)
        for ms0, ms1 in [(0,0),(0,1), (1,0), (1,1)]
    ]
